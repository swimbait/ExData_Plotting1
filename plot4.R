...
plot(dat$DateTime , dat$Voltage, type="l", xlab="DateTime", ylab="Voltage", main="")
...
plot(dat$DateTime , dat$Global_reactive_power, type="l", xlab="DateTime", ylab="Global_reactive_power", main="")
dev.off()
